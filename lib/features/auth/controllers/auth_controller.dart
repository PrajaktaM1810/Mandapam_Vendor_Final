...
class AuthController extends GetxController implements GetxService {
  ...
  void pickGstImage(bool isRemove) async {
    if (isRemove) {
      ...
      pickedGst = await ImagePicker().pickImage(source: ImageSource.gallery);
    }
    update();
  }
  ...
  Future<void> registerStore(Map<String, String> data) async {
    ...
    Response response = await authServiceInterface.registerRestaurant(data, _pickedLogo, _pickedCover,pickedPanCard,pickedUdyamCard,pickedGst);
