...
class AuthRepository implements AuthRepositoryInterface {
  ...
  @override
  Future<Response> registerRestaurant(Map<String, String> data, XFile? logo, XFile? cover, XFile? pan, XFile? udyam, XFile? gst) async {
    return await apiClient.postMultipartData(AppConstants.restaurantRegisterUri, data, [MultipartBody('logo', logo), MultipartBody('cover_photo', cover), MultipartBody('pan_card', logo), MultipartBody('udayam_card', cover),MultipartBody('gst_certificate', logo)]);
  }
