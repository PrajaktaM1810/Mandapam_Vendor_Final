...
class _StoreRegistrationScreenState extends State<StoreRegistrationScreen> with TickerProviderStateMixin {
                    ...
                    Visibility(
                      ...
                      child: Form(
                        ...
                        child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                          ...
                          // Add this after the VAT tax field or any other appropriate location in your form
                          ...
                          Text('Documents', style: robotoBold.copyWith(fontSize: Dimensions.fontSizeLarge)),
                          const SizedBox(height: Dimensions.paddingSizeDefault),

                          Column(
                            crossAxisAlignment: CrossAxisAlignment.start,
                            children: [
                              // Document Upload Card (all in one)
                              Card(
                                elevation: 2,
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      ...
                                      _buildImageUploadSection(
                                        ...
                                        file: authController.pickedPanCard,
                                        onTap: () => authController.pickPanCardImage(false),
                                      ),
                                      ...
                                      _buildImageUploadSection(
                                        context,
                                        title: 'Udyam Card Image',
                                        uploadText: 'Upload Image',
                                        file: authController.pickedUdyamCard,
                                        onTap: () => authController.pickUdyamCardImage(false),
                                      ),
                                      ...
                                      _buildImageUploadSection(
                                        context,
                                        title: 'GST Certificate Image'.tr,
                                        uploadText: 'Upload Image',
                                        file: authController.pickedGst,
                                        onTap: () => authController.pickGstImage(false),
                                      ),
                                    ],
                                  ),
                                ),
              ...
              !authController.isLoading ? Container(
                ...
                child: CustomButtonWidget(
                  ...
                  onPressed: () {
                    ...
                    //     password: password,
                    //     zoneId: addressController.zoneList![addressController.selectedZoneIndex!].id.toString(),
                      ...
                      if(authController.storeStatus == 0.1){
                        if(_formKeyLogin!.currentState!.validate()){
                          if(defaultNameNull) {
                            ...
                            showCustomSnackBar('select_store_cover_photo'.tr);
                          }else if(authController.pickedPanCard == null) {
                            showCustomSnackBar('Select Pan Card Image');
                          }else if(authController.pickedUdyamCard == null) {
                            showCustomSnackBar('Select Udyam Card Image');
                          }else if(authController.pickedGst == null) {
                            showCustomSnackBar('Select GST Certificate Image');
                          }else if(addressController.selectedModuleIndex == -1) {
                            showCustomSnackBar('please_select_module_first'.tr);
                          }else if(defaultAddressNull) {
                            showCustomSnackBar('enter_store_address'.tr);
  ...
  Widget _buildImageUploadSection(
    ...
    return Column(
      ...
      children: [
        Row(children: [
          Text(title, style: robotoRegular.copyWith(color: Theme.of(context).textTheme.bodyLarge?.color?.withOpacity(0.7))),
        ]),
        const SizedBox(height: Dimensions.paddingSizeDefault),
            ...
            children: [
              Padding(
                ...
                child: ClipRRect(
                  ...
                  child: file != null
                      ? GetPlatform.isWeb
                      ? Image.network(file.path, width: 150, height: 120, fit: BoxFit.cover)
                      : Image.file(File(file.path), width: 150, height: 120, fit: BoxFit.cover)
                      : SizedBox(
                    width: 150,
                    height: 120,
                    child: Column(
