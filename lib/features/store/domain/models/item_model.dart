...
class Item {
  ...
  String? itemType; // This will be the 'product_type' in API request
  int? categoryId;
  ...
  Item({
    ...
    this.imageFullUrl,
    this.imagesFullUrl,
    this.itemType, // Initialize 'product_type'
    this.categoryId,
    this.categoryIds,
    this.variations,
    this.foodVariations,
  ...
  Item.fromJson(Map<String, dynamic> json) {
    ...
    itemType = json['product_type']; // Mapping product_type from response
  ...
  Map<String, dynamic> toJson() {
    ...
    data['product_type'] = itemType;  // Pass 'product_type' correctly in the request
