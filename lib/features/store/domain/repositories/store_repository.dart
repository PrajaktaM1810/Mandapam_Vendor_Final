...
class StoreRepository implements StoreRepositoryInterface {
  ...
  Future<Response> addItem(
    ...
    if (Get.find<ProfileController>().profileModel!.stores![0].module!.moduleType == 'grocery' ||
        Get.find<ProfileController>().profileModel!.stores![0].module!.moduleType == 'food') {
      fields.addAll(<String, String>{
    ...
    if (Get.find<ProfileController>().profileModel!.stores![0].module!.moduleType == 'pharmacy') {
      fields.addAll(<String, String>{
        ...
        'condition_id': item.conditionId!.toString(),
      });
    }
    ...
    if (Get.find<ProfileController>().profileModel!.stores![0].module!.moduleType == 'pharmacy') {
      fields.addAll(<String, String>{
        'is_prescription_required': item.isPrescriptionRequired!.toString(),
        'basic': item.isBasicMedicine!.toString(),
      });
    }
    ...
    if (Get.find<ProfileController>().profileModel!.stores![0].module!.moduleType == 'grocery' ||
        Get.find<ProfileController>().profileModel!.stores![0].module!.moduleType == 'food') {
      fields.addAll(<String, String>{
        'is_halal': item.isHalal.toString(),
      });
    }
