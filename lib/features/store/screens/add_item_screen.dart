                ...
                child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                  ...
                  Container(
                    ...
                    child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                      ...
                      //             horizontal: Dimensions.paddingSizeExtraSmall,
                      //           ),
                      //           child: Text('Rental', style: robotoRegular),
                      //         ),
                      //       ),
                      //       DropdownItem<String>(
                      //         value: 'Purchase',
                      ...
                      //             horizontal: Dimensions.paddingSizeExtraSmall,
                      //           ),
                      //           child: Text('Purchase', style: robotoRegular),
                      //         ),
                      //       ),
                      //     ],
                      //     child: Padding(
                      ...
                      Container(
                        ...
                        child: CustomDropdown<String>(
                          ...
                          child: Padding(
                            padding: const EdgeInsets.only(left: 10),
                            child: Text(
                              selectedItemType ?? (_item?.itemType != null && _item!.itemType!.isNotEmpty
                                  ? (() {
                                selectedItemType = _item!.itemType!;
              ...
              !storeController.isLoading ? CustomButtonWidget(
                ...
                onPressed: () {
                  ...
                  if(defaultDataNull) {
                    ...
                    print('Selected Item Type: $selectedItemType');
                    showCustomSnackBar('Please select an Item Type'.tr);
                    ...
                    _item.itemType = selectedItemType;
                    print('Check_Item_Type: ${_item.itemType}');
                    _item.categoryIds = [];
