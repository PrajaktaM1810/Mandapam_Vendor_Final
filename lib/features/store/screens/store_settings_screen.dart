            ...
            !storeController.isLoading ? CustomButtonWidget(
              ...
              onPressed: () {
                ...
                if(defaultNameNull) {
                  ...
                  _store.minimumOrder = double.tryParse(minimumOrder) ?? 0.0;
                  ...
                  _store.minimumShippingCharge = double.tryParse(deliveryFee) ?? 0.0;
                  _store.maximumShippingCharge = maximumFee.isNotEmpty ? (double.tryParse(maximumFee) ?? 0.0) : null;
                  _store.perKmShippingCharge = double.tryParse(deliveryChargePerKm) ?? 0.0;
                  ...
                  _store.extraPackagingAmount = extraPackagingAmount.isNotEmpty ? (double.tryParse(extraPackagingAmount) ?? 0.0) : 0.0;
                  ...
                  _store.minimumStockForWarning = double.tryParse(minimumStockForWarning) ?? 0.0;
